...
// Command     : write_verilog -force -mode synth_stub -rename_top block_design_microblaze_0_0 -prefix
//               block_design_microblaze_0_0_ block_design_microblaze_0_0_stub.v
...
module block_design_microblaze_0_0(Clk, Reset, Interrupt, Interrupt_Address, 
  Interrupt_Ack, Ext_BRK, Ext_NM_BRK, Dbg_Stop, Dbg_Intr, MB_Halted, Wakeup, Sleep, Hibernate, 
  Suspend, Dbg_Wakeup, Dbg_Continue, Reset_Mode, Pause, Pause_Ack, Non_Secure, Instr_Addr, Instr, 
  IFetch, I_AS, IReady, IWAIT, ICE, IUE, Data_Addr, Data_Read, Data_Write, D_AS, Read_Strobe, 
  Write_Strobe, DReady, DWait, DCE, DUE, Byte_Enable, M_AXI_DP_AWADDR, M_AXI_DP_AWPROT, 
  M_AXI_DP_AWVALID, M_AXI_DP_AWREADY, M_AXI_DP_WDATA, M_AXI_DP_WSTRB, M_AXI_DP_WVALID, 
  M_AXI_DP_WREADY, M_AXI_DP_BRESP, M_AXI_DP_BVALID, M_AXI_DP_BREADY, M_AXI_DP_ARADDR, 
  M_AXI_DP_ARPROT, M_AXI_DP_ARVALID, M_AXI_DP_ARREADY, M_AXI_DP_RDATA, M_AXI_DP_RRESP, 
  M_AXI_DP_RVALID, M_AXI_DP_RREADY, Dbg_Clk, Dbg_TDI, Dbg_TDO, Dbg_Reg_En, Dbg_Shift, 
  Dbg_Capture, Dbg_Update, Dbg_Trig_In, Dbg_Trig_Ack_In, Dbg_Trig_Out, Dbg_Trig_Ack_Out, 
  Debug_Rst, Dbg_Disable, M0_AXIS_TLAST, M0_AXIS_TDATA, M0_AXIS_TVALID, M0_AXIS_TREADY, 
