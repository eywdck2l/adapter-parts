...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../adapter.srcs/sources_1/bd/adapter/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../adapter.srcs/sources_1/bd/adapter/ipshared/85a3" \
    "$ref_dir/../../../../adapter.srcs/sources_1/bd/adapter/ipshared/8fb0/src/cmd_if.sv" \
    "$ref_dir/../../../../adapter.srcs/sources_1/bd/adapter/ipshared/8fb0/src/device.sv" \
    "$ref_dir/../../../../adapter.srcs/sources_1/bd/adapter/ipshared/8fb0/src/axi_sd_v1_0_S_AXI.sv" \
