...
execute()
{
  xrun $xrun_opts \
       ...
       -top xil_defaultlib.adapter \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../adapter.srcs/sources_1/bd/adapter/ipshared/c923" \
       +incdir+"$ref_dir/../../../../adapter.srcs/sources_1/bd/adapter/ipshared/ec67/hdl" \
       +incdir+"../../../../adapter.srcs/sources_1/bd/adapter/ipshared/c923" \
       +incdir+"../../../../adapter.srcs/sources_1/bd/adapter/ipshared/ec67/hdl"
}
