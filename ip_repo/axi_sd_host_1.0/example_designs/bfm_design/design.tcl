proc create_ipi_design { offsetfile design_name } {
    ...
    # SD card connections
    create_bd_intf_port -mode Master -vlnv acme:user:sd_rtl:1.0 SD_CARD

    # Interrupt pin
    create_bd_port -dir O -type INTR interrupt

    # Create the DUT
    set axi_sd_host_0 [ create_bd_cell -type ip \
	...
	[get_bd_intf_pins axi_sd_host_0/sd]
    connect_bd_net [get_bd_ports interrupt] \
	[get_bd_pins axi_sd_host_0/interrupt]
	...
	[get_bd_pins axi_sd_host_0/resetn] \
    ...
    set offset_file "${bd_path}/axi_sd_host_v1_0_tb_include.svh"
    set fp [open $offset_file "w"]
    puts $fp "`ifndef axi_sd_host_v1_0_tb_include_vh_"
    puts $fp "`define axi_sd_host_v1_0_tb_include_vh_\n"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/axi_sd_host_v1_0_tb.sv
...
for { set i 1 } { 1 } { incr i } {
    set design_name "axi_sd_host_v1_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 axi_sd_host_v1_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top axi_sd_host_v1_0_tb [get_filesets sim_1]
